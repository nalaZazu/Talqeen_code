...
function Register() {
  ...
  const formOptions = { resolver: yupResolver(SignSchema) };
              ...
              <form onSubmit={data.handleSubmit(SignIn)}>
                ...
                <div className="form-outline mb-2">
                  ...
                  <input
                    ...
                    className={`form-control ${
                      data.formState.errors.address ? "is-invalid" : ""
                    }`}
                    {...data.register("name")}
                  />
                  <div className="error">
                ...
                <div className="form-outline mb-2">
                  ...
                  <input
                    ...
                    id="email"
                    className={`form-control ${
                      data.formState.errors.email ? "is-invalid" : ""
                    }`}
                    {...data.register("email")}
                ...
                <div className="form-outline mb-2">
                  ...
                  />
                  <div className="error">
                    {data.formState.errors.address?.message}
                  </div>
                </div>
                {/* Password input */}
                <div className="form-outline mb-2">
                  ...
                  <input
                    ...
                    className={`form-control ${
                      data.formState.errors.password ? "is-invalid" : ""
                    }`}
                  />
                  <div className="error">
                ...
                <div className="form-outline mb-2">
                  ...
                  <input
                    ...
                    className={`form-control ${
                      data.formState.errors.confirm_password ? "is-invalid" : ""
                    }`}
                  />
                  <div className="error">
                    {data.formState.errors.confirm_password?.message}
                  </div>
                </div>
                {/* Mobile Number */}
                <div className="form-outline mb-2">
                  ...
                  <input
                    ...
                    name="phoneNumber"
                    className={`form-control ${
                      data.formState.errors.phoneNumber ? "is-invalid" : ""
                    }`}
                    {...data.register("phoneNumber")}
                  />
                  <div className="error">
                    {data.formState.errors.phoneNumber?.message}
                  </div>
                  {showButton && (
