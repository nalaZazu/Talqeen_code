              ...
              <form onSubmit={data.handleSubmit(sigOut)}>
                ...
                <div className="form-outline mb-4">
                  ...
                  {data.formState.errors.email &&
                    data.formState.errors.email.type == "required" && (
                      <div className="error"> Please Your Enter Email </div>
                    )}
                </div>
                {/* Password input */}
                <div className="form-outline mb-3">
                  ...
                  {data.formState.errors.password &&
                    data.formState.errors.password.type == "required" && (
                      <div className="error"> Please enter your password</div>
                    )}
                  {data.formState.errors.password &&
                    data.formState.errors.password.type == "minLength" && (
                      <div className="error"> Please Enter 8 character</div>
                    )}
                </div>
