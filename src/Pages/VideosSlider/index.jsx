...
import { VideosSlider } from "../../Constant/videoSilderArray";
        ...
        <div className="container h-100">
          <div className="row">
            ...
            <p className="text-center video_para mt-3">
              ...
              dolorum voluptatum eveniet aliquam, repudiandae molestiae in ipsa
              tenetur doloremque incidunt sit temporibus accusamus omnis ad eum
              ex placeat distinctio vitae!
            </p>
                        ...
                        <div className="card" key={id}>
                          ...
                          >
                            ...
                            <div className="card-body">
                              <h5 className="card-title text-wrap text-break w-100">
                                {name}
                              </h5>
                            </div>
                          </Link>
